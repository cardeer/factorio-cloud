...
data:extend({{
    ...
    name = constants.items.ark_reactor.name,
    ...
    minable = {
        result = constants.items.ark_reactor.name,
        mining_time = 1
    },
    ...
    name = constants.items.ark_reactor.name,
    icon = path .. '/power-generator/icon.png',
    place_result = constants.items.ark_reactor.name,
    icon_size = 32,
    stack_size = 100,
    group = 'production',
    subgroup = 'energy'
    ...
    type = "technology",
    name = constants.items.ark_reactor.name,
    icon = constants.general.graphics_location .. "/power-generator/icon.png",
    icon_size = 200,
    effects = {},
    unit = {
        count = 1000,
