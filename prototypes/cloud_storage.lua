graphics_location = constants.general.graphics_location

cloud_storage = table.deepcopy(data.raw["container"]["steel-chest"])
cloud_storage.name = constants.items.cloud_storage.name
...
cloud_storage.minable.result = constants.items.cloud_storage.name
...
data:extend({cloud_storage, {
    type = 'item',
    name = constants.items.cloud_storage.name,
    icon = graphics_location .. "/cloud-storage/icon.png",
    icon_size = 200,
    subgroup = 'storage',
    order = 'a[items]-b[steel-chest]',
    place_result = constants.items.cloud_storage.name,
    stack_size = 50
}, {
    type = 'recipe',
    name = constants.items.cloud_storage.name,
